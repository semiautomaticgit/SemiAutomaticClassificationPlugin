	...
	def createROI(self, point):
		...
		if cfg.pntROI != None:
			...
			if tSS is None:
				...
				# logger
				if cfg.logSetVal == "Yes": cfg.utls.logToFile(str(__name__) + "-" + str(inspect.stack()[0][3])+ " " + cfg.utls.lineOfCode(), QApplication.translate("semiautomaticclassificationplugin", "Error") + " 2: failed ROI creation")
				cfg.pntROI = None
