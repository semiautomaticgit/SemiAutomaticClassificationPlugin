...
##################################
	...
	def menuIndex(self):
		try:
			nDict = {'Band set': cfg.utls.bandSetTab, 'Basic tools': self.topTree, 'Band set list': cfg.utls.BandSetListTab, 'RGB list': cfg.utls.RGBListTab, 'Algorithm band weight': cfg.utls.algorithmBandWeightTab, 'Multiple ROI creation': cfg.utls.multipleROICreationTab, 'Import signatures': cfg.utls.importSignaturesTab, 'Export signatures': cfg.utls.exportSignaturesTab, 'Signature threshold': cfg.utls.signatureThresholdTab, 'LCS threshold': cfg.utls.LCSThresholdTab, 'Download products': cfg.utls.downloadProductsTab, 'Preprocessing': self.topTree, 'Landsat': cfg.utls.landsatTab, 'Sentinel-1': cfg.utls.sentinel1Tab, 'Sentinel-2': cfg.utls.sentinel2Tab, 'Sentinel-3': cfg.utls.sentinel3Tab, 'ASTER': cfg.utls.asterTab, 'MODIS': cfg.utls.modisTab, 'GOES': cfg.utls.GOESTab, 'Vector to raster': cfg.utls.vectorToRasterTab, 'Clip multiple rasters': cfg.utls.clipMultipleRastersTab, 'Reproject raster bands': cfg.utls.reprojectrasterbandsTab, 'Split raster bands': cfg.utls.splitrasterbandsTab, 'Stack raster bands': cfg.utls.stackrasterbandsTab, 'Mosaic band sets': cfg.utls.mosaicBandSetsTab, 'Cloud masking': cfg.utls.cloudMaskingTab, 'Band processing': self.topTree, 'Classification': cfg.utls.classificationTab,  'Random forest': cfg.utls.randomForestTab, 'PCA': cfg.utls.PCATab, 'Clustering': cfg.utls.clusteringTab,  'Band combination': cfg.utls.bandCombinationTab, 'Spectral distance': cfg.utls.spectralDistanceTab, 'Postprocessing': self.topTree,'Accuracy': cfg.utls.accuracyTab, 'Land cover change': cfg.utls.landCoverChangeTab, 'Classification report': cfg.utls.classificationReportTab, 'Cross classification': cfg.utls.crossClassificationTab, 'Class signature': cfg.utls.classSignatureTab, 'Classification to vector': cfg.utls.classificationToVectorTab, 'Reclassification': cfg.utls.reclassificationTab, 'Edit raster': cfg.utls.editRasterTab, 'Classification sieve': cfg.utls.classificationSieveTab, 'Classification erosion': cfg.utls.classificationErosionTab, 'Classification dilation': cfg.utls.classificationDilationTab, 'Zonal stat raster': cfg.utls.zonalStatRasterTab, 'Band calc': cfg.utls.bandCalcTab, 'Batch': cfg.utls.batchTab, 'Settings': self.topTree, 'Processing setting': cfg.utls.processingSettingTab, 'Interface': cfg.utls.interfaceTab, 'Debug': cfg.utls.debugTab, 'User manual': cfg.ipt.quickGuide, 'Online help': cfg.ipt.askHelp, 'About': cfg.utls.aboutTab, 'Support the SCP': cfg.ipt.supportSCP}
