			...
			if outputRaster is not False:
				...
				if r is not None:
					...
					for s in range(0, size):
						...
						dT = cfg.utls.getTime()
						tPMD = cfg.tmpDir + "/" + dT + "dilation" + str(s) + ".tif"
						tempRasterList = []
						...
						o = cfg.utls.processRaster(input, bL, None, "No", cfg.utls.rasterDilation, None, oMR, None, None, 0, None, cfg.NoDataVal, "No", struct, valueList, "dilation ")
						# boundaries
