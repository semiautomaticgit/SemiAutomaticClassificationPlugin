...
class Settings:
	...
	# virtual  raster
	def virtualRasterCheckbox(self):
		# log setting
		if cfg.ui.virtual_raster_load_checkBox.isChecked() is True:
			cfg.utls.setQGISRegSetting(cfg.vrtRstProjKey, '2')
		elif cfg.ui.virtual_raster_load_checkBox.isChecked() is False:
			cfg.utls.setQGISRegSetting(cfg.vrtRstProjKey, '0')
		cfg.vrtRstProjVal = self.getQGISRegSetting(cfg.vrtRstProjKey, '0')
		
	# checkbox switch sound
	def soundCheckbox(self):
		# sound setting
		if cfg.ui.sound_checkBox.isChecked() is True:
			cfg.utls.setQGISRegSetting(cfg.regSound, '2')
		elif cfg.ui.sound_checkBox.isChecked() is False:
			cfg.utls.setQGISRegSetting(cfg.regSound, '0')
		cfg.soundVal = self.getQGISRegSetting(cfg.regSound, '2')
		# logger
	...
	def threadSettingChange(self):
		...
		cfg.utls.setQGISRegSetting(cfg.regThreadsValue, cfg.threads)
		# logger
	...
	def testGDALSubprocess(self):
		...
		try:
			...
			a = cfg.gdalPath + 'gdalbuildvrt -separate "' + str(tPMD) + '" ' + str(r)
	...
	# set variable for parallel writing
	def parallelWritingCheckbox(self):
		if cfg.ui.parallel_writing_checkBox.isChecked() is True:
			cfg.parallelWritingCheck = 'Yes'
		else:
			cfg.parallelWritingCheck = 'No'
		cfg.utls.setQGISRegSetting(cfg.regparallelWritingCheck, cfg.parallelWritingCheck)
	...
	def SMTPCheckbox(self):
		...
		if cfg.ui.smtp_checkBox.isChecked() is True:
			cfg.utls.setQGISRegSetting(cfg.regSMTPCheck, '2')
		elif cfg.ui.smtp_checkBox.isChecked() is False:
			cfg.utls.setQGISRegSetting(cfg.regSMTPCheck, '0')
