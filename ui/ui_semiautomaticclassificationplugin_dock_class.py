...
class Ui_DockClass(object):
    def setupUi(self, DockClass):
        ...
        self.reset_signature_toolButton = QtGui.QToolButton(self.dockWidgetContents)
        self.reset_signature_toolButton.setObjectName(_fromUtf8("reset_signature_toolButton"))
        self.gridLayout_15.addWidget(self.reset_signature_toolButton, 0, 3, 1, 1)
        ...
        self.gridLayout_16.addItem(spacerItem1, 0, 9, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.export_CSV_library_toolButton, 0, 7, 1, 1)
        ...
        self.merge_signature_toolButton = QtGui.QToolButton(self.dockWidgetContents)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_merge_sign_tool.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.merge_signature_toolButton.setIcon(icon2)
        self.merge_signature_toolButton.setObjectName(_fromUtf8("merge_signature_toolButton"))
        self.gridLayout_16.addWidget(self.merge_signature_toolButton, 0, 2, 1, 1)
        self.import_library_toolButton = QtGui.QToolButton(self.dockWidgetContents)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_import_spectral_library.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.import_library_toolButton.setIcon(icon3)
        self.import_library_toolButton.setObjectName(_fromUtf8("import_library_toolButton"))
        self.gridLayout_16.addWidget(self.import_library_toolButton, 0, 5, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.import_toolButton, 0, 11, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.export_signature_list_toolButton, 0, 10, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.import_usgs_library_toolButton, 0, 6, 1, 1)
        self.signature_spectral_plot_toolButton = QtGui.QToolButton(self.dockWidgetContents)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_sign_tool.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.signature_spectral_plot_toolButton.setIcon(icon5)
        self.signature_spectral_plot_toolButton.setObjectName(_fromUtf8("signature_spectral_plot_toolButton"))
        self.gridLayout_16.addWidget(self.signature_spectral_plot_toolButton, 0, 3, 1, 1)
        ...
        self.algorithm_combo.addItem(_fromUtf8(""))
        self.algorithm_combo.addItem(_fromUtf8(""))
        self.gridLayout_5.addWidget(self.algorithm_combo, 1, 1, 1, 1)
        self.algorithm_weight_button = QtGui.QToolButton(self.dockWidgetContents)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_weight_tool.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.algorithm_weight_button.setIcon(icon6)
        self.algorithm_weight_button.setObjectName(_fromUtf8("algorithm_weight_button"))
        self.gridLayout_5.addWidget(self.algorithm_weight_button, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.macroclass_checkBox, 2, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.alg_threshold_SpinBox, 1, 2, 1, 1)
        self.algorithm_threshold_button = QtGui.QToolButton(self.dockWidgetContents)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_threshold_tool.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.algorithm_threshold_button.setIcon(icon7)
        self.algorithm_threshold_button.setObjectName(_fromUtf8("algorithm_threshold_button"))
        self.gridLayout_5.addWidget(self.algorithm_threshold_button, 1, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_16, 0, 2, 1, 2)
        ...
        self.show_preview_radioButton = QtGui.QRadioButton(self.dockWidgetContents)
        self.show_preview_radioButton.setChecked(True)
        self.show_preview_radioButton.setAutoExclusive(False)
        self.show_preview_radioButton.setObjectName(_fromUtf8("show_preview_radioButton"))
        self.gridLayout_9.addWidget(self.show_preview_radioButton, 1, 3, 1, 1)
        self.zoom_preview_button = QtGui.QToolButton(self.dockWidgetContents)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_zoom_to.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoom_preview_button.setIcon(icon8)
        self.zoom_preview_button.setObjectName(_fromUtf8("zoom_preview_button"))
        self.gridLayout_9.addWidget(self.zoom_preview_button, 1, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.preview_size_spinBox, 0, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.redo_Preview_Button, 0, 5, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.pointerButton_preview, 0, 6, 1, 1)
        spacerItem4 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem4, 0, 4, 1, 1)
        self.preview_transparency_slider = QtGui.QSlider(self.dockWidgetContents)
        self.preview_transparency_slider.setMaximum(100)
        self.preview_transparency_slider.setSingleStep(10)
        self.preview_transparency_slider.setOrientation(QtCore.Qt.Horizontal)
        self.preview_transparency_slider.setObjectName(_fromUtf8("preview_transparency_slider"))
        self.gridLayout_9.addWidget(self.preview_transparency_slider, 1, 6, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.label_18, 1, 5, 1, 1)
        ...
        self.label_18.setBuddy(self.pointerButton_preview)
    ...
    def retranslateUi(self, DockClass):
        ...
        self.reset_signature_toolButton.setToolTip(_translate("DockClass", "<html><head/><body><p>Reset signature list path</p></body></html>", None))
        self.reset_signature_toolButton.setText(_translate("DockClass", "Reset", None))
        ...
        self.export_CSV_library_toolButton.setToolTip(_translate("DockClass", "<html><head/><body><p>Export highlighted signatures to CSV spectral library</p></body></html>", None))
        ...
        self.merge_signature_toolButton.setText(_translate("DockClass", "Plot", None))
        ...
        self.import_toolButton.setText(_translate("DockClass", "Import", None))
        ...
        self.export_signature_list_toolButton.setText(_translate("DockClass", "Export", None))
        ...
        self.algorithm_weight_button.setToolTip(_translate("DockClass", "<html><head/><body><p>Open tab Algorithm  weight</p></body></html>", None))
        ...
        self.show_preview_radioButton.setToolTip(_translate("DockClass", "<html><head/><body><p>Show / hide preview</p></body></html>", None))
        self.show_preview_radioButton.setText(_translate("DockClass", "Show", None))
        self.zoom_preview_button.setToolTip(_translate("DockClass", "<html><head/><body><p>Zoom to preview</p></body></html>", None))
        self.zoom_preview_button.setText(_translate("DockClass", "W", None))
        ...
        self.pointerButton_preview.setToolTip(_translate("DockClass", "<html><head/><body><p><span style=\" font-size:9pt;\">Activate Preview pointer</span></p></body></html>", None))
        self.pointerButton_preview.setText(_translate("DockClass", "+", None))
        self.preview_transparency_slider.setToolTip(_translate("DockClass", "<html><head/><body><p>Set preview transparency</p></body></html>", None))
        self.label_18.setText(_translate("DockClass", "Transparency", None))
