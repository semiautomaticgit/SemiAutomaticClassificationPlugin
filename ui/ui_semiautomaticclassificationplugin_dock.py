...
class Ui_Dock(object):
    def setupUi(self, Dock):
        ...
        self.gridLayout_9.addWidget(self.ROI_tableWidget, 3, 0, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.label_47, 0, 2, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.Max_ROI_width_spin, 1, 2, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.label_46, 0, 1, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.Min_region_size_spin, 1, 1, 1, 1)
        ...
        self.Range_radius_spin.setSingleStep(0.001)
        self.Range_radius_spin.setProperty("value", 0.01)
        self.Range_radius_spin.setObjectName(_fromUtf8("Range_radius_spin"))
        self.gridLayout_16.addWidget(self.Range_radius_spin, 1, 0, 1, 1)
        self.gridLayout_4.addLayout(self.gridLayout_16, 2, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.rapidROI_band_spinBox, 0, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.rapid_ROI_checkBox, 0, 0, 1, 1)
        self.gridLayout_7 = QtGui.QGridLayout()
        self.gridLayout_7.setObjectName(_fromUtf8("gridLayout_7"))
        self.auto_refresh_ROI_radioButton = QtGui.QRadioButton(self.dockWidgetContents)
        ...
        self.gridLayout_7.addWidget(self.auto_refresh_ROI_radioButton, 0, 0, 1, 1)
        self.auto_calculate_ROI_signature_radioButton = QtGui.QRadioButton(self.dockWidgetContents)
        ...
        self.gridLayout_7.addWidget(self.auto_calculate_ROI_signature_radioButton, 0, 1, 1, 1)
        self.gridLayout_8.addLayout(self.gridLayout_7, 1, 0, 1, 2)
        self.gridLayout_4.addLayout(self.gridLayout_8, 3, 1, 1, 1)
        self.gridLayout_9.addLayout(self.gridLayout_4, 7, 0, 1, 1)
        ...
        self.gridLayout_9.addLayout(self.gridLayout_15, 8, 0, 1, 1)
        ...
        self.vegetation_index_comboBox = QtGui.QComboBox(self.dockWidgetContents)
        ...
        self.vegetation_index_comboBox.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.vegetation_index_comboBox, 0, 1, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem5, 0, 2, 1, 1)
        self.display_cursor_checkBox = QtGui.QCheckBox(self.dockWidgetContents)
        self.display_cursor_checkBox.setChecked(True)
        self.display_cursor_checkBox.setObjectName(_fromUtf8("display_cursor_checkBox"))
        self.gridLayout_3.addWidget(self.display_cursor_checkBox, 0, 0, 1, 1)
        ...
        self.mutlipleROI_Button.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.gridLayout_3.addWidget(self.mutlipleROI_Button, 0, 3, 1, 1)
        self.gridLayout_6.addLayout(self.gridLayout_3, 1, 0, 1, 8)
        self.show_ROI_radioButton = QtGui.QRadioButton(self.dockWidgetContents)
        self.show_ROI_radioButton.setChecked(True)
        self.show_ROI_radioButton.setAutoExclusive(False)
        self.show_ROI_radioButton.setObjectName(_fromUtf8("show_ROI_radioButton"))
        self.gridLayout_6.addWidget(self.show_ROI_radioButton, 0, 6, 1, 1)
        self.zoom_ROI_button = QtGui.QPushButton(self.dockWidgetContents)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zoom_ROI_button.sizePolicy().hasHeightForWidth())
        self.zoom_ROI_button.setSizePolicy(sizePolicy)
        self.zoom_ROI_button.setMinimumSize(QtCore.QSize(0, 0))
        self.zoom_ROI_button.setMaximumSize(QtCore.QSize(30, 27))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.zoom_ROI_button.setFont(font)
        self.zoom_ROI_button.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.zoom_ROI_button.setText(_fromUtf8(""))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_zoom_to.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoom_ROI_button.setIcon(icon5)
        self.zoom_ROI_button.setIconSize(QtCore.QSize(18, 18))
        self.zoom_ROI_button.setCheckable(False)
        self.zoom_ROI_button.setFlat(False)
        self.zoom_ROI_button.setObjectName(_fromUtf8("zoom_ROI_button"))
        self.gridLayout_6.addWidget(self.zoom_ROI_button, 0, 7, 1, 1)
        ...
        self.gridLayout_9.addLayout(self.gridLayout_10, 10, 0, 1, 1)
        ...
        self.gridLayout_12.addItem(spacerItem7, 0, 1, 1, 1)
        ...
        self.gridLayout_9.addLayout(self.gridLayout_2, 11, 0, 1, 1)
    ...
    def retranslateUi(self, Dock):
        ...
        self.auto_refresh_ROI_radioButton.setToolTip(_translate("Dock", "<html><head/><body><p>Automatically refresh the temporary ROI, as the parameters change</p></body></html>", None))
        self.auto_refresh_ROI_radioButton.setText(_translate("Dock", "Automatic refresh ROI", None))
        self.auto_calculate_ROI_signature_radioButton.setToolTip(_translate("Dock", "<html><head/><body><p>Automatically calculate signature plot</p></body></html>", None))
        self.auto_calculate_ROI_signature_radioButton.setText(_translate("Dock", "Automatic  plot", None))
        ...
        self.polygonROI_Button.setToolTip(_translate("Dock", "<html><head/><body><p><span style=\" font-size:9pt;\">Create a ROI polygon</span></p></body></html>", None))
        self.pointerButton.setToolTip(_translate("Dock", "<html><head/><body><p><span style=\" font-size:9pt;\">Activate ROI pointer</span></p></body></html>", None))
        self.pointerButton.setText(_translate("Dock", "+", None))
        self.vegetation_index_comboBox.setToolTip(_translate("Dock", "<html><head/><body><p>Select a vegetation index</p></body></html>", None))
        self.vegetation_index_comboBox.setItemText(0, _translate("Dock", "NDVI", None))
        self.vegetation_index_comboBox.setItemText(1, _translate("Dock", "EVI", None))
        self.display_cursor_checkBox.setToolTip(_translate("Dock", "<html><head/><body><p>Display a vegetation index value with the cursor</p></body></html>", None))
        self.display_cursor_checkBox.setText(_translate("Dock", "Display cursor for", None))
