...
class Ui_ScatterPlot(object):
    def setupUi(self, ScatterPlot):
        ...
        ScatterPlot.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedStates))
        self.gridLayout_5 = QtWidgets.QGridLayout(ScatterPlot)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.splitter = QtWidgets.QSplitter(parent=ScatterPlot)
        ...
        self.scatter_list_plot_tableWidget = QtWidgets.QTableWidget(parent=self.layoutWidget)
        ...
        self.scatter_list_plot_tableWidget.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedStates))
        self.scatter_list_plot_tableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.scatter_list_plot_tableWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.Scatter_Widget_2 = ScatterWidget2(parent=self.layoutWidget1)
        ...
        self.frame = QtWidgets.QFrame(parent=ScatterPlot)
        ...
        self.label_49 = QtWidgets.QLabel(parent=self.frame)
        ...
        self.scatter_ROI_Button = QtWidgets.QToolButton(parent=self.frame)
        self.scatter_ROI_Button.setStyleSheet("margin: 0px;padding: 0px;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_enter.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.precision_checkBox = QtWidgets.QCheckBox(parent=self.frame)
        self.precision_checkBox.setObjectName("precision_checkBox")
        self.horizontalLayout_2.addWidget(self.precision_checkBox)
        self.precision_comboBox = QtWidgets.QComboBox(parent=self.frame)
        ...
        self.fitToAxes_pushButton_2 = QtWidgets.QToolButton(parent=self.frame)
        self.fitToAxes_pushButton_2.setStyleSheet("margin: 0px;padding: 0px;")
        self.fitToAxes_pushButton_2.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_fit_plot.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.save_plot_pushButton_2 = QtWidgets.QToolButton(parent=self.frame)
        self.save_plot_pushButton_2.setStyleSheet("margin: 0px;padding: 0px;")
        self.save_plot_pushButton_2.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_save_plot_image.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.colormap_comboBox = QtWidgets.QComboBox(parent=self.frame)
        ...
        self.value_label_2 = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("Liberation Mono")
        font.setBold(True)
        font.setWeight(75)
        self.value_label_2.setFont(font)
        self.value_label_2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.value_label_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.bandY_spinBox = QtWidgets.QSpinBox(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.bandY_spinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.bandX_spinBox = QtWidgets.QSpinBox(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.bandX_spinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.plot_temp_ROI_pushButton = QtWidgets.QToolButton(parent=self.frame)
        self.plot_temp_ROI_pushButton.setStyleSheet("margin: 0px;padding: 0px;")
        self.plot_temp_ROI_pushButton.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/plugins/semiautomaticclassificationplugin/icons/semiautomaticclassificationplugin_scatter_raster_temp_ROI.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_25 = QtWidgets.QLabel(parent=ScatterPlot)
        font = QtGui.QFont()
        font.setFamily("FreeSans")
        font.setBold(True)
