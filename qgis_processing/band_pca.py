...
class BandPCA(AlgorithmTemplate):
    ...
    def shortDescription():
        return (
            'Perform the calculation of Principal Components Analysis on '
            'input bands, producing rasters corresponding to the principal '
            'components. '
            '<a href="https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.band_pca.html">Tool description</a>')  # noqa: E501
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterNumber(
                name=self.VALUE,
                description=self.translate('Number of components'),
                minValue=2, optional=True
            )
        )
        self.addParameter(
            QgsProcessingParameterNumber(
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if parameters[self.VALUE] is None:
            ...
            components_number = self.parameterAsInt(
