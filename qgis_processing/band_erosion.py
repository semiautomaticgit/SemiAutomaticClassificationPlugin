...
class BandErosion(AlgorithmTemplate):
    ...
    def shortDescription():
        return (
            'Perform the spatial erosion, through a moving window, '
            'of band pixels selected by values. '
            '<a href="https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.band_erosion.html">Tool description</a>')  # noqa: E501
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterString(
                ...
                defaultValue='erosion_', multiLine=False
            )
        )
        self.addParameter(
            QgsProcessingParameterBoolean(
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        output = rs.band_erosion(
            input_bands=input_bands, value_list=values, size=int(size),
